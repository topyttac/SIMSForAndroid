...
import simms.biosci.simsapplication.Manager.GermplasmAdapter;
...
public class GermplasmFragment extends Fragment {
    ...
    private GermplasmAdapter germplasmAdapter;
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        germplasmAdapter = new GermplasmAdapter(getContext(), feedGermplasm);
