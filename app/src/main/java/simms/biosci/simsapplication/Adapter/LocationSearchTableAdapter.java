...
public class LocationSearchTableAdapter extends RecyclerView.Adapter<LocationSearchTableAdapter.CustomViewHolder> implements Filterable {
    ...
    public LocationSearchTableAdapter(Context context, List<FeedLocation> feedItems) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.location_table_list, null);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView tv_location, tv_address;
